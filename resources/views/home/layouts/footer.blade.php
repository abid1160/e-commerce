        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-wrap">
            <div class="shipping">
              ...
              <img src="{{asset('home/assets/images/arct-icon.png')}}" alt="icon">
              <img src="{{asset('home/assets/images/dhl-logo.png')}}" alt="icon">
            </div>
            <div class="payment-option">
              <span>Payment Option:</span>
              <img src="{{asset('home/assets/images/visa-card.png')}}" alt="card">
              <img src="{{asset('home/assets/images/paypal-card.png')}}" alt="card">
              <img src="{{asset('home/assets/images/master-card.png')}}" alt="card">
            </div>
          </div>
